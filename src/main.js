...
import { updateStatus, endGame, displayStats, checkLevel, timePlayed, addPotion, addCandy, addLevel, checkEvolve } from './standalone.js';
import $ from 'jquery';
import 'bootstrap';
...
$(document).ready(function() {
  ...
  $("button#start").click(function() {
    if(choice) {
      ...
      tamagotchi.checkCurrentLevel();
      checkEvolve(tamagotchi, choiceURL, choice, prefix);
      displayStats(choice);
